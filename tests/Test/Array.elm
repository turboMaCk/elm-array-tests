module Test.Array exposing (all)
...
all : Test
all =
  let creationTests = describe "Creation"
      ...
      getAndSetTests = describe "Get and Set"
      ...
      takingArraysApartTests = describe "Taking Arrays Apart"
      ...
      mappingAndFoldingTests = describe "Mapping and Folding"
      ...
      nativeTests = describe "Conversion to JS Arrays"
