...
var _elm_lang$core$Main$emit = _elm_lang$core$Native_Platform.outgoingPort(
	'emit',
	function (v) {
		return [v._0, v._1];
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _elm_lang$core$Main$main !== 'undefined') {
    _elm_lang$core$Main$main(Elm['Main'], 'Main', undefined);
}
